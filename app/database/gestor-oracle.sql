CREATE TABLE EAMDadosBasicos( 
 ...
 PRIMARY KEY (id)) ; 
  ...
  CREATE SEQUENCE EAMDadosBasicos_id_seq START WITH 1 INCREMENT BY 1; 

CREATE OR REPLACE TRIGGER EAMDadosBasicos_id_seq_tr 

BEFORE INSERT ON EAMDadosBasicos FOR EACH ROW 
...
SELECT EAMDadosBasicos_id_seq.NEXTVAL INTO :NEW.id FROM DUAL; 
